...
png("raices_var.png", width = 2000, height = 2000, res = 300, bg = "transparent") #exportar
...
ggplot2::ggsave("03_graficos_irf_remesas.pdf", plot = grafico_irf, width = 7, height = 8)
...
ggplot2::ggsave("04_graficos_irf_generales_pesaran.pdf", plot = grafico_irf_general, width = 7, height = 8)
...
readr::write_csv(tabla_fevd_roa, "fevd_roa_desglosado.csv")
