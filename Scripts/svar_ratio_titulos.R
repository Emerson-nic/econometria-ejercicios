...
png("Graficos/raices_var_titulos.png", width = 2000, height = 2000, res = 300, bg = "transparent") #exportar
...
pdf("Graficos/cusm_titulos.pdf", width = 9, height = 7)
...
# Guardar CSV
readr::write_csv(irf_data, "Csv de dataset y resultados/irf_spillover_remesas_titulos.csv")
...
ggplot2::ggsave("Graficos/03_graficos_irf_remesas_titulos.pdf", plot = grafico_irf, width = 7, height = 8)
...
# Guardar CSV
readr::write_csv(irf_data_general, "Csv de dataset y resultados/irf_spillover_remesas_generales_titulos.csv")
...
ggplot2::ggsave("Graficos/04_graficos_irf_generales_pesaran_titulos.pdf", plot = grafico_irf_general, width = 7, height = 8)
...
readr::write_csv(tabla_fevd_roa, "Csv de dataset y resultados/fevd_roa_desglosado_titulos.csv")
...
ggplot2::ggsave("Graficos/05_grafico_fevd_roa_formal_titulos.pdf", plot = grafico_fevd_roa, width = 7.5, height = 5)